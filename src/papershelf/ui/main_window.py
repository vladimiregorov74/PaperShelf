...
class MainWindow(BaseWindow):
    ...
    def _on_stale_selectors(
        ...
        Статья была скачана пустой — вероятно, сайт изменил
        структуру страницы. Предлагает пользователю удалить
        сохранённые настройки сайта и повторить сохранение.
    
        Parameters
        ----------
        url:
            Адрес статьи, которую не удалось разобрать.
    
        identifier:
            Идентификатор сайта в реестре
